...
def Plugins(**kwargs):
	...
	if boxResolution == "FHD":
		myList.append(PluginDescriptor(name = "Enby", description = "Emby Client for Enigma2 based on DreamPlex", where = [PluginDescriptor.WHERE_PLUGINMENU], icon = "pluginLogoHD.png", fnc=main))
	else:
		myList.append(PluginDescriptor(name = "Enby", description = "Emby Client for Enigma2 based on DreamPlex", where = [PluginDescriptor.WHERE_PLUGINMENU], icon = "pluginLogo.png", fnc=main))
